...
// Converte a categoria do banco ("Cultos") para o formato usado no site ("cultos")
...
export default function MensagensCultosPage() {
  ...
  return (
    <>
      <PageHeader
        title="Mensagens — Cultos"
        description="Assista às mensagens pregadas em nossos cultos"
      />
