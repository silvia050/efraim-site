...
// Converte a categoria do banco ("Kids/Teens") para o formato usado no site ("kids-teens")
...
export default function MensagensKidsTeensPage() {
  ...
  return (
    <>
      <PageHeader
        title="Cultinhos Kids e Teens"
        description="Mensagens especiais preparadas com carinho para as crianças e adolescentes do Ministério Efraim"
      />
